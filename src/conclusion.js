...
const Conclusion = () => (
  <div>
    ...
    <p>What if we were to pull 1,000 tweets a week from each language for 10 years and see if it reflects an attitude change. Or track some cultures we know who have radically different ways of dealing with death than we have in the west. Also, if we could begin to segment based on demographics, interests, etc. What if we could find a subset of twitter users that had the most positive outlook on death based on sentient analysis. What if we could track them for five years? Are they happier, healthier, what can they teach us about life just by the way they talk about death. It would be fascinating to look at funeral costs cross sectioned with sentiment analysis. I did some preliminary reseach and it looks like the cost of a funeral might be slightly higher in France than in the United States once you calcuate in cemetary services. Does France's more negative outlook on death mean they hide from it even more than we do, thus allowing the French funeral industry to be even more predatory? It's hard to say, but with the correct data we could begin to make these predictions. 
